...
public class AEDriveEntiy extends TileEntity implements IInventory {
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        ...
        if (this.hasCustomName()) {
            nbt.setString("Drive", this.getCustomName());
        }
    }
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("Drive", 8)) {
            this.setCustomName(nbt.getString("Drive"));
        }
    }
    ...
    public boolean hasCustomName() {
        return this.Drive != null && !this.Drive.equals("");
    }
